...
// ═══ 启动 ═══
console.log('[BB-Memory] ✅ 全量代码（含所有函数定义）已执行到启动点');
console.log('[BB-Memory] readyState:', document.readyState);

// 暂时不执行 IIFE，仅测试函数定义是否导致模块失败
globalThis.bbMemoryTestInit = init;

console.log('[BB-Memory] ✅ 模块加载完成（IIFE 已禁用，init 暴露为 bbMemoryTestInit）');
