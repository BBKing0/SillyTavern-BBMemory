...
- 只要记忆的 v 包含人物原话，s 必须填写这句话的说话者，a 必须填写对话对象；不能把说话者与对象颠倒或留空。
...
v=人物重要原话(无则""，优先保留承诺/威胁/告白/预言/关键对白)
s=说话者/事实主体名 | a=对话对象/事实目标名（v非空时两者必须填写）
...
字段格式：
1. memories 数组：
{ "n":"标题", "tp":"event/emotion/habit/fact", "m":"一句话摘要", "c":"1-3句事实摘要", "v":"人物重要原话", "s":"说话者/事实主体", "a":"对话对象/事实目标", "i":0.6, "e":0.2, "st":"具体故事时间", "g":["标签"] }
...
export async function reextractFloor(chatId, floor, options = {}) {
    ...
    try {
        ...
        // v9.4.3 整理只允许用户手动启动；重新提取仅回填实时记忆场景标识。
